...
export declare type Props = Record<string, string | null> & {
    comment?: string[];
};
export declare type GlyphMetaInFont = [
    string,
    number,
    number,
    number,
...
export declare type TodataFuncRetType<T> = T extends undefined ? string[] : T extends 0 ? string : T extends 1 ? string[] : T extends 2 ? number[][] : T extends 3 ? number[] : T extends 4 ? string[] : T extends 5 ? number[] : never;
export declare type CodepointRangeType = number | [number, number] | [number, number][];
export declare type OrderType = -1 | 0 | 1 | 2;
export declare type GlyphDrawModeType = -1 | 0 | 1 | 2;
...
export declare type DirectionType = keyof typeof DIRE_SHORTCUT_MAP;
export declare type DirectionNumberType = typeof DIRE_MAP[keyof typeof DIRE_MAP];
/**
 * `Font` object
 *
