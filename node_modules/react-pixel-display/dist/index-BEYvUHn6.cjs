  ...
  static concatall(bitmaplist, options = {}) {
    ...
    if (_direction > 0) {
      ...
      const stroffconcat = (s1, s2, offset2) => {
        if (_direction === 1) {
          return Bitmap.__string_offset_concat(s1, s2, offset2);
        } else {
          return Bitmap.__string_offset_concat(s2, s1, offset2);
        }
      };
  ...
  replace(substr, newsubstr) {
    ...
    const replaceAll = (str, substr2, newsubstr2) => {
      if ("replaceAll" in String.prototype) {
        ...
        return str.replace(new RegExp(escapeRegExp(substr2), "g"), newsubstr2);
      }
    };
...
exports.Font = Font;
exports.Glyph = Glyph;
//# sourceMappingURL=index-BEYvUHn6.cjs.map
