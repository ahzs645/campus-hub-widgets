...
async function ensureBdfParser() {
  ...
  try {
    const bdfparser = await Promise.resolve().then(() => require("./index-BEYvUHn6.cjs"));
    const fetchline = await Promise.resolve().then(() => require("./index-D2PEo4D8.cjs"));
    $Font = bdfparser.$Font;
    const fl = fetchline;
...
exports.AmbientEffects = AmbientEffects;
exports.BDF_FONT_CONFIG = BDF_FONT_CONFIG;
exports.COLOR_EFFECTS = COLOR_EFFECTS;
exports.CanvasLEDRenderer = CanvasLEDRenderer;
exports.ColorEffects = ColorEffects;
exports.EFFECTS = EFFECTS;
exports.EFFECT_CATEGORIES = EFFECT_CATEGORIES;
exports.EffectManager = EffectManager;
exports.FONT_METRICS = FONT_METRICS;
exports.ImageDataLEDRenderer = ImageDataLEDRenderer;
exports.SVGLEDMatrixRenderer = SVGLEDMatrixRenderer;
exports.TEXT_EFFECTS = TEXT_EFFECTS;
exports.TextEffects = TextEffects;
exports.configureFonts = configureFonts;
exports.createPixelSvg = createPixelSvg;
exports.getAvailableBdfFonts = getAvailableBdfFonts;
exports.getHeightKey = getHeightKey;
exports.getHeightKey$1 = getHeightKey$1;
exports.hexToRgb = hexToRgb;
exports.hexToRgbObj = hexToRgbObj;
exports.hsvToRgb = hsvToRgb;
exports.isBdfFontLoaded = isBdfFontLoaded;
exports.isFontLoaded = isFontLoaded;
exports.loadBdfFont = loadBdfFont;
exports.loadFont = loadFont;
exports.pixelFont = pixelFont;
exports.preloadBdfFonts = preloadBdfFonts;
exports.preloadFonts = preloadFonts;
exports.setFontResolver = setFontResolver;
exports.setFontResolver$1 = setFontResolver$1;
exports.textToPixels = textToPixels;
exports.textToPixelsBdf = textToPixelsBdf;
exports.textToPixelsCanvas = textToPixelsCanvas;
exports.textToScrollPixels = textToScrollPixels;
exports.textToScrollPixelsBdf = textToScrollPixelsBdf;
exports.textToScrollPixelsCanvas = textToScrollPixelsCanvas;
//# sourceMappingURL=index-H0p6sO8X.cjs.map
