...
export type TextEffectName = 'fixed' | 'scroll_ltr' | 'scroll_rtl' | 'blink' | 'breeze' | 'snow' | 'laser' | 'fade' | 'typewriter' | 'bounce' | 'sparkle';
export type AmbientEffectName = 'rainbow' | 'matrix' | 'plasma' | 'gradient' | 'fire' | 'water' | 'stars' | 'confetti' | 'plasma_wave' | 'radial_pulse' | 'hypnotic' | 'lava' | 'aurora';
