...
import { DarkContainer, buildCacheKey, buildProxyUrl, fetchJsonWithCache, type WidgetComponentProps, useFitScale, useLoopingAutoScroll } from '@firstform/campus-hub-widget-sdk';
